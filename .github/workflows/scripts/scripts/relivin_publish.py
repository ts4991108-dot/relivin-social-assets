...
CTA="Download ReLivin on the App Store → relivin.app"; TAGS="#ReLivin #FamilyMemories #Parenthood #Keepsake"

BANK=[
 ("warm","Your camera roll, calmed","The camera roll forgets. You won't.",
  "Ten thousand photos, zero order. ReLivin turns the chaos of your camera roll into one calm timeline — every photo and video filed by age, so the moment you're looking for is always right where you left it.",
  "#ReLivin #FamilyMemories #MemoryKeeping #Parenthood"),
 ("bold","For your people","Grandma shouldn't need Instagram.",
  "The people who love your kids most are usually the worst at finding your posts. ReLivin gives them one private place to see every new memory the moment you add it — no app to learn, no algorithm, no ads.",
  "#ReLivin #FamilyMemories #Grandparents #PrivateByDesign"),
 ("editorial","Organized by age","A childhood, in order.",
  "Not by upload date. Not by file name. By age — the way you actually remember it. ReLivin quietly arranges every photo, video, and note into one timeline that reads like the story it is.",
  "#ReLivin #FamilyMemories #Keepsake #Parenthood"),
 ("warm","Every first, kept","First steps. First words. First everything.",
  "The firsts happen once, usually when you're least ready. ReLivin keeps them the second they happen — captured, filed by age, and impossible to lose in a sea of screenshots.",
  "#ReLivin #Milestones #FamilyMemories #Motherhood"),
 ("bold","Safe for good","Screenshots aren't a backup.",
  "One cracked screen and years of memories are gone. ReLivin is the private, permanent home your family's photos and videos deserve — organized, shared only with your people, and built to outlast every phone you'll ever own.",
  "#ReLivin #Backup #FamilyMemories #Keepsake"),
]
...
def generate(out):
    ...
    items=[]
    for i,(style,tag,head,body,tags) in enumerate(picks,1):
